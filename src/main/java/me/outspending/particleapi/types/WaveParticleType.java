...
/**
 * Represents a particle type that renders as a wave.
 * <p>
 ...
 * <ul>
 *     <li>{@code radius} ({@link Double}) - The radius of the wave</li>
 *     <li>{@code density} ({@link Integer}) - The density of the wave</li>
 *     <li>{@code height} ({@link Double}) - The height of the wave</li>
 *     <li>{@code rotation} ({@link Double}) - The rotation of the wave</li>
 * </ul>
 *
